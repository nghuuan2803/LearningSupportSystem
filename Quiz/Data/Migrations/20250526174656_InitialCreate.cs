        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowExplanationAfterSubmit = table.Column<bool>(type: "boolean", nullable: false),
                    AllowViewResult = table.Column<bool>(type: "boolean", nullable: false),
                    AllowEnroll = table.Column<bool>(type: "boolean", nullable: false),
                    CandidateCodeRequire = table.Column<bool>(type: "boolean", nullable: false),
                    EnrollFee = table.Column<double>(type: "double precision", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Matching = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamAttempts_AspNetUsers_CandidateId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CandidateCode = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamCandidates", x => new { x.ExamId, x.CandidateId });
                    table.ForeignKey(
                        name: "FK_ExamCandidates_AspNetUsers_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamCandidates_CandidateId",
